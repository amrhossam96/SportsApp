//
//  OnboardingSportTableViewCell.swift
//  Sports
//
...
class OnboardingSportTableViewCell: UITableViewCell {

    static let identifier = "OnboardingSportTableViewCell"
    ...
    func configure(with model: SportTableViewModel) {
        label.text = model.sportName
        guard let url = URL(string: model.sportIcon) else {return}
