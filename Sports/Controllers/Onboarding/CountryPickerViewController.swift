...
extension CountryPickerViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if !countries[indexPath.row].isSelected {
            ...
            selectedCountries.append(countries[indexPath.row].countryName)
        } else {
            countries[indexPath.row].isSelected = false
            selectedCountries.remove(at: selectedCountries.firstIndex(of: countries[indexPath.row].countryName)!)
        }
        
        delegate?.countryPickerViewControllerDidPickCountries(self)
